...
export class Concurrents extends Component {
  ...
  createClick() {
    ...
    axios.post('https://localhost:7230/api/Concurrents', {
  ...
  updateClick() {
    ...
    axios.put(`https://localhost:7230/api/Concurrents/${this.state.idConcurrent}`, {
  ...
  deleteClick(idConcurrent) {
    if (window.confirm('Êtes-vous sûr?')) {
      axios.delete(`https://localhost:7230/api/Concurrents/${idConcurrent}`)
        .then(response => {
