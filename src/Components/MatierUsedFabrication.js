...
export class MatierUsedFabrication extends Component {
  ...
  refreshList() {
    axios.get('https://localhost:7230/api/MatierUsedFabrications')
      .then(response => {
  ...
  createClick = () => {
    ...
    axios.post('https://localhost:7230/api/MatierUsedFabrications', {
  ...
  updateClick = () => {
    ...
    axios.put(`https://localhost:7230/api/MatierUsedFabrications/${this.state.idFab}`, {
  ...
  deleteClick = (idFab) => {
    if (window.confirm('Are you sure?')) {
      axios.delete(`https://localhost:7230/api/MatierUsedFabrications/${idFab}`)
        .then(response => {
          if (response.status === 200 || response.status === 204) {
