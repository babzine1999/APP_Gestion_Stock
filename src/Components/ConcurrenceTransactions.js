...
export class ConcurrenceTransactions extends Component {
  ...
  refreshList() {
    axios.get('https://localhost:7230/api/ConcurrenceTransactions')
      .then(response => {
  ...
  loadConcurrents() {
    axios.get('https://localhost:7230/api/Concurrents')
      .then(response => {
  ...
  createClick() {
    ...
    axios.post('https://localhost:7230/api/ConcurrenceTransactions', {
  ...
  updateClick() {
    ...
    axios.put(`https://localhost:7230/api/ConcurrenceTransactions/${this.state.id}`, {
  ...
  deleteClick(id) {
    if (window.confirm('Are you sure?')) {
      axios.delete(`https://localhost:7230/api/ConcurrenceTransactions/${id}`)
        .then(response => {
          if (response.status === 200 || response.status === 204) {
